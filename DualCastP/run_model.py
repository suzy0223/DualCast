...
if __name__ == '__main__':
    ...
    parser.add_argument('--l_flt', type=str2bool, default=True,
                        help='whether use filter loss')
    parser.add_argument('--l_env', type=str2bool, default=True,
                        help='whether use DBI loss')
    parser.add_argument('--l_dbi', type=str2bool, default=True,
                        help='whether use environment loss')
    parser.add_argument('--alpha', type=float,
                        default=0.1, help='coefficeint for kl')
    parser.add_argument('--beta', type=float,
                        default=0.1, help='coefficeint for dbi')
    parser.add_argument('--gamma', type=float,
                        default=1, help='coefficeint for permute')
    parser.add_argument('--slot_per_h', type=int,default=12, help='slot per hour')
    parser.add_argument('--run_count', type=int,
                        default=1, help='times of run')
